...
exports.DateTimeFormat.__addLocaleData = function __addLocaleData() {
    ...
    for (var _a = 0, data_1 = data; _a < data_1.length; _a++) {
        ...
        var _loop_1 = function (locale) {
            try {
                var _a = ecma402_abstract_1.unpackData(locale, datum), dateFormat = _a.dateFormat, timeFormat = _a.timeFormat, dateTimeFormat = _a.dateTimeFormat, formats_1 = _a.formats, rawData = tslib_1.__rest(_a, ["dateFormat", "timeFormat", "dateTimeFormat", "formats"]);
